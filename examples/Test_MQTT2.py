...
MEASURE_DURATION_MS = 11  # Desired measurement duration in milliseconds
...
def main():
    ...
    try:
        ...
        print("Set Measurement Duration: ", admm_set(ser, CMD_SET_MEASURE_DURATION, MEASURE_DURATION_MS)[1])
